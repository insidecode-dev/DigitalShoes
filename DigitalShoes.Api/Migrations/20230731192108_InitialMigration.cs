        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageUrl = table.Column<string>(type: "nvarchar(200)", nullable: true),
                    ProfileImageLocalPath = table.Column<string>(type: "nvarchar(200)", nullable: true),
                    Balance = table.Column<decimal>(type: "decimal(6,2)", nullable: false, defaultValue: 0.00m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageLocalPath = table.Column<string>(type: "nvarchar(200)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataStatus = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPrice = table.Column<decimal>(type: "decimal(6,2)", nullable: false, defaultValue: 0.00m),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataStatus = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Brand = table.Column<string>(type: "nvarchar(40)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentObjects", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<int>(type: "int", nullable: false),
                    ShoeId = table.Column<int>(type: "int", nullable: false),
                    ReviewText = table.Column<string>(type: "nvarchar(200)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoeHashtags", x => new { x.ShoeId, x.HashtagId });
                    table.ForeignKey(
                        name: "FK_ShoeHashtags_Hashtags_HashtagId",
                        column: x => x.HashtagId,
                        principalTable: "Hashtags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoeHashtags_Shoes_ShoeId",
                        column: x => x.ShoeId,
                        principalTable: "Shoes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoeWishlists", x => new { x.ShoeId, x.WishlistId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentObjects_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoeHashtags_HashtagId",
                table: "ShoeHashtags",
                column: "HashtagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoeWishlists_WishlistId",
                table: "ShoeWishlists",
                column: "WishlistId");
